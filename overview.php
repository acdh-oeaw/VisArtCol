...
<html lang="en-US">
  <head>
    ...
    <title>VisArtCol - Artworks Overview</title>
      ...
      <div class="wrapper-fluid wrapper-navbar sticky-navbar" id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container" >
            ...
            <a href="/" class="navbar-brand custom-logo-link" rel="home" itemprop="url"><img src="images/visartcol-logo.svg" class="img-fluid" alt="VisArtCol Logo" itemprop="logo" /></a><!-- end custom logo -->
